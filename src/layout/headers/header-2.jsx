                            ...
                            <div className="header-top">
                                <div className="header-top-left">
                                    <ul className="header-info">
                                        ...
                                        <li><a href="mailto:anbu@frontl.in" rel="noreferrer" target="_blank"><i className="icon-envelope"></i>Email: anbu@frontl.in</a></li>
                                    </ul>
                                </div>
                            ...
                            <div className="header-brand">
                                <div className="logo">
                                    <Link href="/" legacyBehavior>
                                        <a>
                                            <img className="logo-light" src={style_3 ? '/assets/images/speak-logo/speakSure.png' : "/assets/images/speak-logo/speakSure.png"} alt="Corporate Logo" />
                                            <img className="logo-dark" src={style_3 ? '/assets/images/speak-logo/speakSure.png' : "/assets/images/speak-logo/speakSure.png"} alt="Corporate Logo" />
                                        </a>
                                    </Link>
                                </div>
                            </div>
