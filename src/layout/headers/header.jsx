...
import Cart from './component/cart';
  ...
  const products = [
        ...
        { id: 11, name: 'French', link: '/course-details/18'},
                            ...
                            <div className="header-right">
                                <ul className="header-action">
                                    ...
                                    <li className="icon search-icon">
                                        <button style={{cursor:'pointer';}} onClick={() => setIsSearchOpen(true)} className="search-trigger">
{/*                                             <i className="icon-2"></i> */}
                                            <i className="icon-2" style={{fontSize: "30px";}} ></i>
                                        </button> 
                                    ...
                                    <li className="mobile-menu-bar d-block d-xl-none">
                                        <button id="text" className="hamberger-button" onClick={() => setIsOpen(true)}>
