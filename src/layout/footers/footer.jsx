                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="inner text-center">
                                <p>Copyright {new Date().getFullYear()} <a href="https://speaksure.in/" rel="noreferrer" target="_blank" aria-label="Speaksure">Speaksure</a> Designed By <a href="https://frontlinetech.in/" rel="noreferrer" target="_blank">Frontline Technologies</a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
